...
module.exports = (app) => {
  ...
  app.use("/docs/integrations", express.static(`/../../airbyte/docs/integrations`));
  //workaround for adblockers to serve google ads docs in development
  app.use(
    "/docs/integrations/sources/gglad.md",
    express.static(`/../../airbyte/docs/integrations/sources/google-ads.md`)
  );
  app.use("/docs/.gitbook", express.static(`/../../airbyte/docs/.gitbook`));
};
